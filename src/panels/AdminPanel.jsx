...
//         if (editingProject) {
//             await axios.put(`${API}/projects/${editingProject}`, fd);
//         } else {
...
//         if (editingExp) {
//             await axios.put(`${API}/experience/${editingExp}`, experience);
//         } else {
...
//         fd.append("issuer", cert.issuer);
//         fd.append("year", cert.year);
...
//                 {["profile", "projects", "experience", "certifications"].map((s) => (
//                     <button
//                         key={s}
//                         onClick={() => setSection(s)}
//                         className={`block w-full text-left px-3 py-2 rounded ${section === s ? "bg-gray-700" : ""
//                             }`}
//                     >
//                         {s.toUpperCase()}
//                     </button>
...
//                 <button
//                     onClick={logout}
//                     className="mt-10 w-full bg-red-600 py-2 rounded"
//                 >
//                     Logout
//                 </button>
//             </aside>
...
//                         <textarea className="border p-2 w-full mb-2" placeholder="Bio"
...
//                         <input className="border p-2 w-full" placeholder="Tech"
//                             value={project.tech}
//                             onChange={e => setProject({ ...project, tech: e.target.value })} />
//                         <input type="file" onChange={e => setProjectImage(e.target.files[0])} />
//                         <button onClick={saveProject} className="bg-black text-white px-6 py-2 rounded">
...
//                         <input className="border p-2 w-full" placeholder="Role"
//                             value={experience.role}
//                             onChange={e => setExperience({ ...experience, role: e.target.value })} />
//                         <textarea className="border p-2 w-full" placeholder="Description"
//                             value={experience.description}
//                             onChange={e => setExperience({ ...experience, description: e.target.value })} />
//                         <button onClick={saveExperience} className="bg-black text-white px-6 py-2 rounded">
